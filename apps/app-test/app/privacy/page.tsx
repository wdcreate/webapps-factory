    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="text-base leading-relaxed">
          Welcome to TravelEco (“we”, “our”, “us”). We are committed to
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            <strong>Personal Data:</strong> Name, email address, postal address,
            phone number.
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            To communicate with you, including for customer service and updates.
          </li>
      ...
      <section className="mb-8">
        ...
        <p className="text-base leading-relaxed">
          ...
          information can be guaranteed 100% secure.
        </p>
      </section>
