    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="text-base leading-relaxed">
          This Cookie Policy explains how [Your Company Name] (“we”, “our”,
          “us”) uses cookies and similar technologies on our website. By using
          our site, you consent to the use of cookies as described in this
          policy.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-base leading-relaxed">
          ...
          mobile) when you visit a website. They help the site recognize your
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            <strong>Strictly Necessary Cookies:</strong> Required for basic site
            functionality (e.g., page navigation, secure areas).
          </li>
          <li>
            <strong>Performance Cookies:</strong> Collect anonymous information
            about site usage to help us improve performance.
          </li>
          <li>
            <strong>Functional Cookies:</strong> Remember choices you make
            (e.g., language, region) to provide enhanced features.
          </li>
          <li>
            <strong>Targeting/Advertising Cookies:</strong> Used to deliver
            relevant ads and track ad performance.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-base leading-relaxed">
          ...
          are governed by the respective provider’s privacy and cookie policies.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-base leading-relaxed">
          You can control or delete cookies via your browser settings. Most
        ...
        <ul className="list-disc list-inside space-y-2 mt-4">
          ...
          <li>
            Block all cookies by default (note: this may break some site
            features).
          </li>
        </ul>
      ...
      <section className="mb-8">
        ...
        <p className="text-base leading-relaxed">
          ...
          posted here with a “Last updated” date. Continued use after updates
