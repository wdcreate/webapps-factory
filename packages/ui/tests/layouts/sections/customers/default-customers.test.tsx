...
const makeData = (overrides: PartialSection = {}): DefaultCustomerLogosSection => ({
...
describe('<DefaultCustomerLogos />', () => {
 ...
 it('applies inline style when backgroundSrc is truthy', () => {
  ...
  it('throws when logos prop is missing or wrong type', () => {
    ...
    const badData = ({ sectionId: 'x', heading: 'x' } as unknown) as DefaultCustomerLogosSection;
    expect(() => render(<DefaultCustomerLogos data={badData} />)).toThrow(TypeError);
  });
