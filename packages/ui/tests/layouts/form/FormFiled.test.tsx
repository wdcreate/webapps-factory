...
describe('FormField Component', () => {
  let onChange: (name: string, value: string | number | boolean | File | null) => void;
  ...
  it('renders text input with label, placeholder, description and required asterisk', () => {
    render(<FormField field={defaultField} value="" error={undefined} onChange={onChange} />);
  ...
  it('renders checkbox and toggles value correctly', () => {
    const cbField: FormFieldConfig = { ...defaultField, type: 'checkbox', label: 'Check me' };
  ...
  it('displays error message when error prop provided', () => {
    render(<FormField field={defaultField} value="" error="Something wrong" onChange={onChange} />);
